...
public class UserIDBase64 {
     ...
     */
	public static Long decoderUserID(String encodedUserID)  {
		...
		try {
			...
			return Long.valueOf(base64Encoded);
		} catch (Exception e) {
			return null;
		}
	}
     ...
     */
	public static String encoderUserID(Long userID){
	...
	public static void main(String[] args) {
		System.out.println(encoderUserID(20L));
